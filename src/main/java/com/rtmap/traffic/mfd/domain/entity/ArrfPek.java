 ...
 */
@Entity
@Table(name = "flt_arrf_pek")
@XmlRootElement(name = "INBO")
@XmlAccessorType(XmlAccessType.FIELD)
public class ArrfPek {
	@Id
	@Column(name = "arrf_id", updatable = false)
	...
	private String park;
	@Column(name = "exits_no")
	@XmlElement(name = "EXIT")
	private String exitsNo;
	@Column(name = "route")
	@XmlElement(name = "EROU")
	private String route;
	@Column(name = "start_airport_code")
	@XmlElement(name = "SAIR")
	private String startAirportCode;
	@Column(name = "start_airport_en")
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "create_time", columnDefinition = "TIMESTAMP", insertable = true, updatable = false)
	...
	public String getExitsNo() {
		return exitsNo;
	}

	public void setExitsNo(String exitsNo) {
		this.exitsNo = exitsNo == null ? null : exitsNo.trim();
	}
	...
	public void setStartAirportCode(String startAirportCode) {
		this.startAirportCode = startAirportCode == null ? null : startAirportCode.trim();
	}
	...
	public void setStartAirportEn(String startAirportEn) {
		this.startAirportEn = startAirportEn == null ? null : startAirportEn.trim();
	}
	 ...
	 * 自定义属性
	 */
	@Column(name = "blt_disp")
	private String bltDisp;
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "first_blt_ot", columnDefinition = "DATETIME")
	private Date firstBltOt;
	...
	public void setBltDisp(String bltDisp) {
		this.bltDisp = bltDisp == null ? null : bltDisp.trim();
	}

	public Date getFirstBltOt() {
		return firstBltOt;
	}

	public void setFirstBltOt(Date firstBltOt) {
	 ...
	 */
	@Transient
	@XmlElements(@XmlElement(name = "OPFC"))
	private List<ArrfBeltPek> belts;

	public List<ArrfBeltPek> getBelts() {
		return belts;
	}

	public void setBelts(List<ArrfBeltPek> belts) {
		this.belts = belts;
	}
}